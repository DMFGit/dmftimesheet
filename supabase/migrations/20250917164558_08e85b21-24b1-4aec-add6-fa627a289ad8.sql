-- Fix critical security vulnerability: Role-Based Access Control (Corrected)
...
-- Create granular policy that allows profile updates but prevents role/status changes
...
-- Admin-only policy for complete employee management
