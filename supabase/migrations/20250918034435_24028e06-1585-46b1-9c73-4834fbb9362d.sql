...
-- 1. Attach security triggers to Employees table
CREATE TRIGGER IF NOT EXISTS prevent_role_escalation_trigger
    BEFORE UPDATE ON public."Employees"
    FOR EACH ROW EXECUTE FUNCTION public.prevent_role_escalation();

CREATE TRIGGER IF NOT EXISTS log_employee_changes_trigger
